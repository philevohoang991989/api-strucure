...
import {listUserGroup, createUserGroup, updateUserGroup, deleteUserGroup} from '../services/userGroup/'
...
export const UpdateUserGroup = async (req: Request, res: Response, next: Function) =>{
...
export const DeleteUserGroup = async (req: Request, res: Response, next: Function) =>{
